...
from model.token_classification import (
    ...
    BertPromptForTokenClassification,
    RobertaPrefixForTokenClassification,
    RobertaPromptForTokenClassification,
...
from model.sequence_classification import (
    ...
    BitfitBertForSequenceClassification,
)

from model.question_answering import (
    BertPrefixForQuestionAnswering,
    BertPromptForQuestionAnswering,
    RobertaPrefixModelForQuestionAnswering,
    RobertaPromptModelForQuestionAnswering,
    DebertaPrefixModelForQuestionAnswering,
    LoraBertForQuestionAnswering,
    BitfitBertForQuestionAnswering,
)
...
from model.multiple_choice import (
    ...
    LoraBertForMultipleChoice,
    BitfitBertForMultipleChoice,
)
...
PROMPT_MODELS = {
    "bert": {
        ...
        TaskType.QUESTION_ANSWERING: BertPromptForQuestionAnswering,
        TaskType.TOKEN_CLASSIFICATION: BertPromptForTokenClassification,
    },
    "roberta": {
        ...
        TaskType.QUESTION_ANSWERING: RobertaPromptModelForQuestionAnswering,
        TaskType.TOKEN_CLASSIFICATION: RobertaPromptForTokenClassification,
    }
}

LORA_MODELS = {
    "bert": {
        TaskType.SEQUENCE_CLASSIFICATION: LoraBertForSequenceClassification,
        TaskType.MULTIPLE_CHOICE: LoraBertForMultipleChoice,
        TaskType.QUESTION_ANSWERING: LoraBertForQuestionAnswering,
    }
}

BITFIT_MODELS = {
    "bert": {
        TaskType.SEQUENCE_CLASSIFICATION: BitfitBertForSequenceClassification,
        TaskType.MULTIPLE_CHOICE: BitfitBertForMultipleChoice,
        TaskType.QUESTION_ANSWERING: BitfitBertForQuestionAnswering,
    }
}
...
def get_model(model_args, task_type: TaskType, config: AutoConfig, fix_bert: bool = False):
    ...
    elif model_args.bitfit:
        model_class = BITFIT_MODELS[config.model_type][task_type]
        model = model_class.from_pretrained(
            model_args.model_name_or_path,
            config=config,
            revision=model_args.model_revision,
