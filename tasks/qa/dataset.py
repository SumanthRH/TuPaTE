...
def get_dataset_handle(dataset_name):
    if dataset_name in ['squad', 'squad_v2']:
        return dataset_name
    else:
        return f'tasks/qa/squad_format_datasets/{dataset_name}.py'
...
class SQuAD:
    ...
    def __init__(self, tokenizer: AutoTokenizer, data_args, training_args, qa_args) -> None:
        ...
        self.version_2 = data_args.dataset_name != "squad"

        raw_datasets = load_dataset(get_dataset_handle(data_args.dataset_name))
